...
import { Eye, EyeOff, Sparkles, Film, ArrowRight, Check } from "lucide-react";
  ...
  return (
    <div className="min-h-screen flex">
      ...
      <motion.div
        ...
        className="hidden lg:flex lg:w-1/2 relative overflow-hidden bg-gradient-to-br from-purple-950/20 via-zinc-950 to-red-950/20"
      >
        {/* Animated background elements */}
        <FloatingOrb color="purple" size="lg" className="top-1/4 left-1/4" />
        <FloatingOrb color="blue" size="md" className="bottom-1/3 right-1/4" />
        <FloatingOrb color="red" size="sm" className="top-3/4 left-2/3" />
          ...
          >
            ...
            <div className="flex items-center gap-3">
              <motion.div
                ...
                className="h-12 w-12 rounded-2xl bg-gradient-to-br from-purple-600 to-purple-700 flex items-center justify-center shadow-lg shadow-purple-500/30"
              >
                <Film className="h-6 w-6 text-white fill-white" />
              </motion.div>
              <span className="text-3xl font-bold bg-gradient-to-r from-purple-400 via-white to-blue-400 bg-clip-text text-transparent">
                CineCraze
              </span>
            </div>
            ...
            <div className="space-y-4">
              ...
              >
                Create your account and get instant access to exclusive content, personalized recommendations, and more.
              </motion.p>
            </div>
            ...
            <div className="relative p-8 space-y-6">
              ...
              <div className="text-center space-y-2">
                <motion.div
                  ...
                  className="inline-flex items-center justify-center w-16 h-16 rounded-2xl bg-gradient-to-br from-purple-600 to-purple-700 mb-4 shadow-lg shadow-purple-500/30"
                >
                ...
                >
                  {(field) => (
                    <AppField
                      ...
                      className="bg-zinc-950/50 border-white/10 focus:border-purple-500/50"
                    />
                  )}
                </form.Field>
                ...
                >
                  {([canSubmit, isSubmitting]) => (
                    <AppSubmitButton
                      ...
                      disabled={!canSubmit}
                      className="w-full bg-gradient-to-r from-purple-600 to-purple-700 hover:from-purple-700 hover:to-purple-800 border-0 shadow-lg shadow-purple-500/30"
                    >
                      Create Account
                    </AppSubmitButton>
                  )}
              ...
              >
                <Button
                  ...
                  onClick={() => {
                    ...
                    window.location.href = `${baseUrl}/auth/register/google`;
                  }}
                >
              ...
              <div className="text-center text-sm text-muted-foreground">
                ...
                <Link
                  href="/login"
                  className="text-purple-400 font-medium hover:text-purple-300 hover:underline underline-offset-4 transition-colors"
                >
                  Sign in
                </Link>
              </div>
